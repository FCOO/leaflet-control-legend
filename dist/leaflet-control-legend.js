/****************************************************************************
	leaflet-control-legend.js, 

	(c) 2015, FCOO

	https://github.com/FCOO/leaflet-control-legend
    ...
    L.Control.Legend = L.Control.extend({
        ...
        removeLegend: function(legendId) {
            ...
            // reset counter if no legend is in collection
						...
						/* Removed by Niels Holt 2016-02-19
            ...
            if (containerEmpty) {
                ...
                this._container.style.display = 'none';
						...
						*/
						...
						//Added by Niels Holt 2016-02-19
						if ( $.isEmptyObject( this.legendOptions ) ){
							this._container.style.display = 'none';
						} 
        ...
        _redrawLegend: function() {
            ...
            $.each(this.legendOptions, function(idx, options) {
                ...
                //br never used; var br = L.DomUtil.create('br', '', that._container);
                L.DomUtil.create('br', '', that._container);
